...
public class RecordDoorBellFragment extends BaseFragment {
    ...
    public RecordDoorBellFragment(String deviceId) {
...
//        UIHelper.showLoading(getActivity(), "加载中...");
    ...
    public void initData() {
        ...
        recordListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.putExtra(Const.LOGTYPE, Const.DOORBELL);
    ...
    private void getRecordList1(final int s) {
        ...
        if (isLoadMore && firstVisibleID != -1) {
            AppOperate.getRecordListDoor(deviceId, Const.DOORBELL, s,
    ...
    private void getRecordList2(final int page) {
        ...
        AppOperate.getRecordListDoor(deviceId, Const.DOORBELL, page,
                pageRows, (RxAppCompatActivity) mContext, new Report() {
                    @Override
                    public void onSucces(Object o) {
                        recordListview.onRefreshComplete();
    ...
    private void changePage(String type) {
        if (type.equals(Const.DOORBELL) && RecordDoorBellFragment.isRefresh) {
            RecordDoorBellFragment.page += 1;
        }
    }
                ...
                pageRows, (RxAppCompatActivity) mContext, new Report() {
                    ...
                    public void onSucces(Object o) {
                        ...
                        if (firstrecordBean.size() == 0) {
                            Toast.makeText(getContext(), "没有门铃记录", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        ...
                        RecordsBellPoliceAdapter bellPoliceAdapter = new RecordsBellPoliceAdapter(Const.DOORBELL, getContext(), mListItems);
